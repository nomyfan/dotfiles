...
local on_attach = function(client, bufnr)
  ...
  set_keymap("n", "gr", vim.lsp.buf.rename, bufopts)
  set_keymap("n", "gR", vim.lsp.buf.references, bufopts)
  set_keymap("n", "ga", vim.lsp.buf.code_action, bufopts)
  set_keymap("n", "<space>f", function() vim.lsp.buf.format { async = true } end, bufopts)
end
